  ...
  replaceSelectedStrByEle = (e) => {
    ...
    if (sel && sel.rangeCount) {
      ...
      range.setStart(firstRange.startContainer, firstRange.startOffset)
        ...
        // console.log(firstRange.startContainer, 'firstRange.startContainer')
        // console.log(firstRange.startOffset, 'firstRange.startOffset')
        // console.log(lastRange.endContainer, 'lastRange.endContainer')
        // console.log(lastRange.endOffset, 'lastRange.endOffset')
    ...
    return (
      <div>
        ...
        <div>
          ...
          {/* <button onClick={this.replaceSelectedStrByEle}>取消</button> */}
        </div>
